...
# restic 0.18 works against it, multipart and `check --read-data`
# included.
...
#
# Pinned by digest — the multi-arch index's, so amd64 and arm64 each
# get their own binary; the tag is for Dependabot and for people.
